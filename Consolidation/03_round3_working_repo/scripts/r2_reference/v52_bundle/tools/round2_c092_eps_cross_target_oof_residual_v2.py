...
def main() -> None:
    ...
    script_path = root / "tools" / "round2_c092_eps_cross_target_oof_residual_v2.py"
    reference_path = root / "tools" / "initial_reference_pipeline.py"
    audit = {
        "schema_version": "ppp.round2.c092.eps-cross-target-oof-residual-run.v2",
    ...
    write_json(run_dir / "config.json", {
        "schema_version": "ppp.round2.c092.eps-cross-target-oof-residual.v2",
        "seed": 2026,
        "target": TARGET,
        "auxiliary_targets": AUXILIARY,
        "outer_folds": 5,
    ...
    manifest.extend([
        f"{audit['source_hashes']['script']}  SOURCE tools/round2_c092_eps_cross_target_oof_residual_v2.py",
