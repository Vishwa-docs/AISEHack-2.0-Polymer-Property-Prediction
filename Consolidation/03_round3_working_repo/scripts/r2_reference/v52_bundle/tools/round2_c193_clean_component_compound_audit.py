#!/usr/bin/env python3
"""C193: deterministic clean component compound audit.

This child does not introduce a new model family.  It runs after the queued
C188--C194 children and assembles only targets whose own completed clean run
passed its preregistered component gate.  The priority order is frozen here to
avoid selecting the highest same-OOF number post hoc.
...
def main() -> None:
    ...
    report = {
        "schema_version": "ppp.round2.c193.clean-component-compound-audit.v1",
