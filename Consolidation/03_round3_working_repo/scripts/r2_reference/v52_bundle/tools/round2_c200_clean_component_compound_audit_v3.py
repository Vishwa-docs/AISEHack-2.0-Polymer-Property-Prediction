#!/usr/bin/env python3
"""C200: deterministic clean component compound audit v3.

This child does not introduce a new model family.  It runs after the queued
C199 child and assembles only targets whose own completed clean run passed its
...
def main() -> None:
    ...
    report = {
        "schema_version": "ppp.round2.c200.clean-component-compound-audit.v3",
