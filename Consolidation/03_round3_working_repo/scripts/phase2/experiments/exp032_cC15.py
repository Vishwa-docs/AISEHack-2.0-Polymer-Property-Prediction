#!/usr/bin/env python3
"""R3-CC15 [cC15] - Phase C: Weak-target physics with ported R2 engines. Experiment 32/150. Real grouped-CV pipeline; reads ONLY official Dataset/ inputs."""
