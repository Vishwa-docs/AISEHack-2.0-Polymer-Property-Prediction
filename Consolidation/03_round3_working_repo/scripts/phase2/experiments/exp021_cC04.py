#!/usr/bin/env python3
"""R3-CC04 [cC04] - Phase C: Weak-target physics with ported R2 engines. Experiment 21/150. Real grouped-CV pipeline; reads ONLY official Dataset/ inputs."""
