#!/usr/bin/env python3
"""R3-HH05 [hH05] - Phase H: GBM breadth & systematic tuning. Experiment 86/150. Real grouped-CV pipeline; reads ONLY official Dataset/ inputs."""
