#!/usr/bin/env python3
"""R3-AA04 [aA04] - Phase A: V57 reproduction. Experiment 5/150. Real grouped-CV pipeline; reads ONLY official Dataset/ inputs."""
...
def run_experiment(output_dir: Path, smoke: bool = False, data_dir: Path | None = None) -> dict[str, object]:
    ...
    model_fn = lambda X, y: mo.FastRidgeArm(alpha=18, seed=SEED).fit(X, y)
