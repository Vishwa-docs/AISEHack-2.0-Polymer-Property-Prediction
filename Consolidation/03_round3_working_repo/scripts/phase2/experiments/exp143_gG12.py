#!/usr/bin/env python3
"""R3-GG12 [gG12] - Phase G: Compound audits & packaging. Experiment 143/150. Real grouped-CV pipeline; reads ONLY official Dataset/ inputs."""
