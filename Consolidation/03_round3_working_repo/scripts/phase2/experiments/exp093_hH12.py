#!/usr/bin/env python3
"""R3-HH12 [hH12] - Phase H: GBM breadth & systematic tuning. Experiment 93/150. Real grouped-CV pipeline; reads ONLY official Dataset/ inputs."""
