#!/usr/bin/env python3
"""R3-AA02 [aA02] - Phase A: V57 reproduction. Experiment 3/150. Real grouped-CV pipeline; reads ONLY official Dataset/ inputs."""
...
def run_experiment(output_dir: Path, smoke: bool = False, data_dir: Path | None = None) -> dict[str, object]:
    ...
    model_fn = lambda X, y: mo.PerTargetEnsemble(seed=SEED, ridge_alpha=20, et_estimators=140, gbm_rounds=300).fit(X, y)
