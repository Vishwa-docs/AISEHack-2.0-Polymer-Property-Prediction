#!/usr/bin/env python3
"""R3-GG06 [gG06] - Phase G: Compound audits & packaging. Experiment 137/150. Real grouped-CV pipeline; reads ONLY official Dataset/ inputs."""
