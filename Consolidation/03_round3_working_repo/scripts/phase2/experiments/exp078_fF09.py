#!/usr/bin/env python3
"""R3-FF09 [fF09] - Phase F: TTA, invariance, explainability. Experiment 78/150. Real grouped-CV pipeline; reads ONLY official Dataset/ inputs."""
