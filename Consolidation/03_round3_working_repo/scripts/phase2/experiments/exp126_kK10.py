#!/usr/bin/env python3
"""R3-KK10 [kK10] - Phase K: Proper multi-task & cross-property. Experiment 126/150. Real grouped-CV pipeline; reads ONLY official Dataset/ inputs."""
...
def run_experiment(output_dir: Path, smoke: bool = False, data_dir: Path | None = None) -> dict[str, object]:
    ...
    print(f"[{EXP_ID}] starting - Proper multi-task & cross-property")
    def model_fn(X, y):
