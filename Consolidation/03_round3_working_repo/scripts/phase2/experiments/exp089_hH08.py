#!/usr/bin/env python3
"""R3-HH08 [hH08] - Phase H: GBM breadth & systematic tuning. Experiment 89/150. Real grouped-CV pipeline; reads ONLY official Dataset/ inputs."""
