#!/usr/bin/env python3
"""R3-CC20 [cC20] - Phase C: Weak-target physics with ported R2 engines. Experiment 37/150. Real grouped-CV pipeline; reads ONLY official Dataset/ inputs."""
