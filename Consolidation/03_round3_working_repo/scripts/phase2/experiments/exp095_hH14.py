#!/usr/bin/env python3
"""R3-HH14 [hH14] - Phase H: GBM breadth & systematic tuning. Experiment 95/150. Real grouped-CV pipeline; reads ONLY official Dataset/ inputs."""
