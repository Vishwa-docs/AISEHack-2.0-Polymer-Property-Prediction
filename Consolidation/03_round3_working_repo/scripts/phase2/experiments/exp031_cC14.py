#!/usr/bin/env python3
"""R3-CC14 [cC14] - Phase C: Weak-target physics with ported R2 engines. Experiment 31/150. Real grouped-CV pipeline; reads ONLY official Dataset/ inputs."""
