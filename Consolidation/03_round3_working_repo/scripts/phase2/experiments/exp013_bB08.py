#!/usr/bin/env python3
"""R3-BB08 [bB08] - Phase B: Selection repair on the clean arm bank. Experiment 13/150. Real grouped-CV pipeline; reads ONLY official Dataset/ inputs."""
