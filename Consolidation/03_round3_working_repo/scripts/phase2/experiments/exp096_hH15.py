#!/usr/bin/env python3
"""R3-HH15 [hH15] - Phase H: GBM breadth & systematic tuning. Experiment 96/150. Real grouped-CV pipeline; reads ONLY official Dataset/ inputs."""
