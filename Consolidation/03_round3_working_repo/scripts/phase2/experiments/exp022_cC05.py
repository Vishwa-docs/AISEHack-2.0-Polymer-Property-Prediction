#!/usr/bin/env python3
"""R3-CC05 [cC05] - Phase C: Weak-target physics with ported R2 engines. Experiment 22/150. Real grouped-CV pipeline; reads ONLY official Dataset/ inputs."""
