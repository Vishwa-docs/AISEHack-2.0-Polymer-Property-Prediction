#!/usr/bin/env python3
"""R3-FF04 [fF04] - Phase F: TTA, invariance, explainability. Experiment 73/150. Real grouped-CV pipeline; reads ONLY official Dataset/ inputs."""
