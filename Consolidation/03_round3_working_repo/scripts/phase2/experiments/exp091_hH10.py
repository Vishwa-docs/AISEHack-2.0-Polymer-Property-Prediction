#!/usr/bin/env python3
"""R3-HH10 [hH10] - Phase H: GBM breadth & systematic tuning. Experiment 91/150. Real grouped-CV pipeline; reads ONLY official Dataset/ inputs."""
