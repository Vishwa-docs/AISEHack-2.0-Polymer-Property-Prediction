#!/usr/bin/env python3
"""R3-CC11 [cC11] - Phase C: Weak-target physics with ported R2 engines. Experiment 28/150. Real grouped-CV pipeline; reads ONLY official Dataset/ inputs."""
