#!/usr/bin/env python3
"""R3-BB02 [bB02] - Phase B: Selection repair on the clean arm bank. Experiment 7/150. Real grouped-CV pipeline; reads ONLY official Dataset/ inputs."""
