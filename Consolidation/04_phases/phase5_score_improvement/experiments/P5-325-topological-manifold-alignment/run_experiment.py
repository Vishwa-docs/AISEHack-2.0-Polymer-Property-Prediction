#!/usr/bin/env python3
"""
Experiment P5-325: Wave 10 (PLAN AMENDMENT) — Continuous Multi-Scale Topological Manifold Alignment
- Applies Optimal Transport & Procrustes alignment on continuous SVD spaces from smile_r3.csv and PI1M.csv.
...
def main():
    parser = argparse.ArgumentParser(description="Run P5-325 Continuous Topological Manifold Alignment")
    ...
    print("\n=== Stage 2: Training GBDTs with Topological Manifold Alignment ===", flush=True)
    ...
    print(f"\n==========================================", flush=True)
    print(f"Mean OOF R² (Topological Manifold Alignment): {mean_oof:.5f}", flush=True)
    print(f"==========================================", flush=True)
    ...
    print(f"\n✅ Experiment P5-325 complete! Hash: {pred_hash}", flush=True)
