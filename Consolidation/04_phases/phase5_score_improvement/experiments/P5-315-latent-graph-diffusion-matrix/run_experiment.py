#!/usr/bin/env python3
"""
Experiment P5-315: Wave 9 (PLAN AMENDMENT) — Multi-Task Constrained Latent Graph Diffusion Matrix
- Fuses graph Laplacian dynamics with cross-property SVD diffusion across all 7 target coordinates.
...
def main():
    parser = argparse.ArgumentParser(description="Run P5-315 Latent Graph Diffusion Matrix")
    ...
    print("\n=== Stage 2: Training GBDTs with Latent Graph Diffusion Matrix ===", flush=True)
    ...
    print(f"\n==========================================", flush=True)
    print(f"Mean OOF R² (Latent Graph Diffusion Matrix): {mean_oof:.5f}", flush=True)
    print(f"==========================================", flush=True)
    ...
    print(f"\n✅ Experiment P5-315 complete! Hash: {pred_hash}", flush=True)
