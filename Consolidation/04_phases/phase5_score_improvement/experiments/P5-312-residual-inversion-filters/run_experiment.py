#!/usr/bin/env python3
"""
Experiment P5-312: Wave 9 (PLAN AMENDMENT) — Direct Target Residual Inversion Filters
- Implements direct residual inversion for high-variance polymers:
  1. Identifies non-linear residual signatures in Tg and eps out-of-fold predictions.
  2. Uses harmonic potential kernels to regularize predictions toward physical boundaries.
  3. Evaluates SLSQP convex blending across all targets.
"""
...
def main():
    parser = argparse.ArgumentParser(description="Run P5-312 Residual Inversion Filters")
    ...
    print("\n=== Stage 2: Training GBDTs with Residual Inversion Filters ===", flush=True)
    ...
    print(f"\n==========================================", flush=True)
    print(f"Mean OOF R² (Residual Inversion Filters): {mean_oof:.5f}", flush=True)
    print(f"==========================================", flush=True)
    ...
    print(f"\n✅ Experiment P5-312 complete! Hash: {pred_hash}", flush=True)
