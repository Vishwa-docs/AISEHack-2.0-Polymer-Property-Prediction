#!/usr/bin/env python3
"""
Experiment P5-323: Wave 10 (PLAN AMENDMENT) — Hierarchical Cross-Domain Multi-Scale Energy Network
- Combines polymer torsional energy surrogates, conjugation potentials, and high-order topological features.
...
def main():
    parser = argparse.ArgumentParser(description="Run P5-323 Multi-Scale Energy Network")
    ...
    print("\n=== Stage 2: Training GBDTs with Multi-Scale Energy Network ===", flush=True)
    ...
    print(f"\n==========================================", flush=True)
    print(f"Mean OOF R² (Multi-Scale Energy Network): {mean_oof:.5f}", flush=True)
    print(f"==========================================", flush=True)
    ...
    print(f"\n✅ Experiment P5-323 complete! Hash: {pred_hash}", flush=True)
