#!/usr/bin/env python3
"""R3-CC07 [cC07] - Phase C: Weak-target physics with ported R2 engines. Experiment 24/150. Real grouped-CV pipeline; reads ONLY official Dataset/ inputs."""
