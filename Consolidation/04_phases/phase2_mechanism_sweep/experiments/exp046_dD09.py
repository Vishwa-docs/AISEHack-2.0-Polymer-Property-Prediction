#!/usr/bin/env python3
"""R3-DD09 [dD09] - Phase D: Dedicated Tg push. Experiment 46/150. Real grouped-CV pipeline; reads ONLY official Dataset/ inputs."""
...
def run_experiment(output_dir: Path, smoke: bool = False, data_dir: Path | None = None) -> dict[str, object]:
    ...
    print(f"[{EXP_ID}] starting - Dedicated Tg push")
    def model_fn(X, y):
