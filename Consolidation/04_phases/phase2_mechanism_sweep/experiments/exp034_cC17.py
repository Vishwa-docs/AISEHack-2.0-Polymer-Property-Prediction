#!/usr/bin/env python3
"""R3-CC17 [cC17] - Phase C: Weak-target physics with ported R2 engines. Experiment 34/150. Real grouped-CV pipeline; reads ONLY official Dataset/ inputs."""
