#!/usr/bin/env python3
"""R3-LL05 [lL05] - Phase L: Data curation & validation controls. Experiment 131/150. Real grouped-CV pipeline; reads ONLY official Dataset/ inputs."""
...
def run_experiment(output_dir: Path, smoke: bool = False, data_dir: Path | None = None) -> dict[str, object]:
    ...
    print(f"[{EXP_ID}] starting - Data curation & validation controls")
