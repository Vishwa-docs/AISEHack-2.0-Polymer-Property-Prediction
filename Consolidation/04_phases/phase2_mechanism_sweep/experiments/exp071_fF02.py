#!/usr/bin/env python3
"""R3-FF02 [fF02] - Phase F: TTA, invariance, explainability. Experiment 71/150. Real grouped-CV pipeline; reads ONLY official Dataset/ inputs."""
