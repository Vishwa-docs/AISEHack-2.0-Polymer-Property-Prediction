#!/usr/bin/env python3
"""R3-HH03 [hH03] - Phase H: GBM breadth & systematic tuning. Experiment 84/150. Real grouped-CV pipeline; reads ONLY official Dataset/ inputs."""
