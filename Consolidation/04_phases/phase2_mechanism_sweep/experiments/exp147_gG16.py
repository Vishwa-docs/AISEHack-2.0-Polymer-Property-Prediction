#!/usr/bin/env python3
"""R3-GG16 [gG16] - Phase G: Compound audits & packaging. Experiment 147/150. Real grouped-CV pipeline; reads ONLY official Dataset/ inputs."""
