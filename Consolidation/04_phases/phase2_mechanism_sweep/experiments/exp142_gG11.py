#!/usr/bin/env python3
"""R3-GG11 [gG11] - Phase G: Compound audits & packaging. Experiment 142/150. Real grouped-CV pipeline; reads ONLY official Dataset/ inputs."""
