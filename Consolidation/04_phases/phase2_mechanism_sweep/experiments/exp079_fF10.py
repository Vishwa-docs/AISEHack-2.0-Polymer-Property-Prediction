#!/usr/bin/env python3
"""R3-FF10 [fF10] - Phase F: TTA, invariance, explainability. Experiment 79/150. Real grouped-CV pipeline; reads ONLY official Dataset/ inputs."""
