#!/usr/bin/env python3
"""R3-FF05 [fF05] - Phase F: TTA, invariance, explainability. Experiment 74/150. Real grouped-CV pipeline; reads ONLY official Dataset/ inputs."""
