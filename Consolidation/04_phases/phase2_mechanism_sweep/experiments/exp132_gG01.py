#!/usr/bin/env python3
"""R3-GG01 [gG01] - Phase G: Compound audits & packaging. Experiment 132/150. Real grouped-CV pipeline; reads ONLY official Dataset/ inputs."""
