#!/usr/bin/env python3
"""R3-FF01 [fF01] - Phase F: TTA, invariance, explainability. Experiment 70/150. Real grouped-CV pipeline; reads ONLY official Dataset/ inputs."""
