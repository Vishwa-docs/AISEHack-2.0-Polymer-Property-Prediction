#!/usr/bin/env python3
"""R3-LL02 [lL02] - Phase L: Data curation & validation controls. Experiment 128/150. Real grouped-CV pipeline; reads ONLY official Dataset/ inputs."""
