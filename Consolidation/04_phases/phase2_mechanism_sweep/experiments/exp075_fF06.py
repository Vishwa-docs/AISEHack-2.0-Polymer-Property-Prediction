#!/usr/bin/env python3
"""R3-FF06 [fF06] - Phase F: TTA, invariance, explainability. Experiment 75/150. Real grouped-CV pipeline; reads ONLY official Dataset/ inputs."""
