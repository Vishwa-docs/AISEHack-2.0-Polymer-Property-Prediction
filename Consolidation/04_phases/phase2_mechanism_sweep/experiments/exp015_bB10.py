#!/usr/bin/env python3
"""R3-BB10 [bB10] - Phase B: Selection repair on the clean arm bank. Experiment 15/150. Real grouped-CV pipeline; reads ONLY official Dataset/ inputs."""
...
def run_experiment(output_dir: Path, smoke: bool = False, data_dir: Path | None = None) -> dict[str, object]:
    ...
    # Crippen molar refractivity feature block
    def feature_fn(texts):
        texts = list(texts)
        base = f.full_feature_stack(texts, use_svd=True, svd_dim=128)
