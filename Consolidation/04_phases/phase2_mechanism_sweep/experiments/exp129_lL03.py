#!/usr/bin/env python3
"""R3-LL03 [lL03] - Phase L: Data curation & validation controls. Experiment 129/150. Real grouped-CV pipeline; reads ONLY official Dataset/ inputs."""
