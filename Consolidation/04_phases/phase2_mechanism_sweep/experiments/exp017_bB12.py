#!/usr/bin/env python3
"""R3-BB12 [bB12] - Phase B: Selection repair on the clean arm bank. Experiment 17/150. Real grouped-CV pipeline; reads ONLY official Dataset/ inputs."""
