#!/usr/bin/env python3
"""R3-FF03 [fF03] - Phase F: TTA, invariance, explainability. Experiment 72/150. Real grouped-CV pipeline; reads ONLY official Dataset/ inputs."""
