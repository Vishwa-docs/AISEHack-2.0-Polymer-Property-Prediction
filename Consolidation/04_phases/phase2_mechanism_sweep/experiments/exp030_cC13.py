#!/usr/bin/env python3
"""R3-CC13 [cC13] - Phase C: Weak-target physics with ported R2 engines. Experiment 30/150. Real grouped-CV pipeline; reads ONLY official Dataset/ inputs."""
