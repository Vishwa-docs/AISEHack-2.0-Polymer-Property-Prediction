#!/usr/bin/env python3
"""R3-GG02 [gG02] - Phase G: Compound audits & packaging. Experiment 133/150. Real grouped-CV pipeline; reads ONLY official Dataset/ inputs."""
