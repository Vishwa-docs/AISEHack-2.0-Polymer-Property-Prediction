#!/usr/bin/env python3
"""R3-FF07 [fF07] - Phase F: TTA, invariance, explainability. Experiment 76/150. Real grouped-CV pipeline; reads ONLY official Dataset/ inputs."""
...
def run_experiment(output_dir: Path, smoke: bool = False, data_dir: Path | None = None) -> dict[str, object]:
    ...
    print(f"[{EXP_ID}] starting - TTA, invariance, explainability")
    def model_fn(X, y):
