#!/usr/bin/env python3
"""R3-II10 [iI10] - Phase I: Weak-target specialist zoo. Experiment 106/150. Real grouped-CV pipeline; reads ONLY official Dataset/ inputs."""
...
def run_experiment(output_dir: Path, smoke: bool = False, data_dir: Path | None = None) -> dict[str, object]:
    ...
    print(f"[{EXP_ID}] starting - Weak-target specialist zoo")
    def model_fn(X, y):
