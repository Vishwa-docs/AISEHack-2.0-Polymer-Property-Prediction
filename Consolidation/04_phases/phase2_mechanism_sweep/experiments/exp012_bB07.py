#!/usr/bin/env python3
"""R3-BB07 [bB07] - Phase B: Selection repair on the clean arm bank. Experiment 12/150. Real grouped-CV pipeline; reads ONLY official Dataset/ inputs."""
