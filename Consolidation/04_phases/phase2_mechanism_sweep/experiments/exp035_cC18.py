#!/usr/bin/env python3
"""R3-CC18 [cC18] - Phase C: Weak-target physics with ported R2 engines. Experiment 35/150. Real grouped-CV pipeline; reads ONLY official Dataset/ inputs."""
