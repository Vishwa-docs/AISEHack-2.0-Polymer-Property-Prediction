#!/usr/bin/env python3
"""R3-HH13 [hH13] - Phase H: GBM breadth & systematic tuning. Experiment 94/150. Real grouped-CV pipeline; reads ONLY official Dataset/ inputs."""
