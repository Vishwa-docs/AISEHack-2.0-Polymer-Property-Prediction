# P5A-004 — P5A-004-eps-ionic-residual
...
**Experiment-specific config:** {"eps_residual":true}

**Gate:** eps oracle R2 >= baseline_eps + 0.010 (fold-consistent)

**Run:** bash ../run.sh P5A-004   (or all: bash ../run.sh)
