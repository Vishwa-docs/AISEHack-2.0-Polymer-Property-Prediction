#!/usr/bin/env python3
"""P5A-001 - Tg fat-tail attack: Huber objective + OOF-residual reweighting + median-of-models ensemble for tg. Clean lane: reads ONLY official train.csv / test.csv
...
def main():
    ...
    print("DONE P5A-001 mean_oof_r2=%.4f" % metrics["mean_oof_r2"])
