#!/usr/bin/env python3
"""P5A-005 - ei via egc+eea identity overlay with stronger guarded alpha (0.8 max). Clean lane: reads ONLY official train.csv / test.csv
...
def main():
    ...
    print("DONE P5A-005 mean_oof_r2=%.4f" % metrics["mean_oof_r2"])
