# P5A-100 — P5A-100-v57-baseline

**Focus:** untouched V57 standalone copy - Mac yardstick (expect ~0.9023)
**Arms:** none (pristine V57)
...
Run: bash run_final.sh P5A-100   (or all: bash run_final.sh)
