...
a. You may submit a maximum of three (3) Submissions per day. b. You may select up to two (2) Final Submissions for judging.
...
a. Under Section 2.8 (Winner’s Obligations) of the General Rules, if you are selected as a Competition winner, you hereby grant and will grant the Competition Sponsor the following licenses with respect to your winning Submission:

Non-Exclusive License. You hereby grant and will grant to the Competition Sponsor and its designees a worldwide, non-exclusive, sublicensable, transferable, fully paid-up, royalty-free, perpetual, and irrevocable license to use, reproduce, distribute, create derivative works of, publicly perform, publicly display, digitally perform, make, have made, sell, offer for sale, and import your winning Submission and the source code used to generate the Submission, in any media now known or hereafter developed, for any purpose whatsoever, whether commercial or non-commercial, without further approval or compensation to you.

Open-Source License. You hereby license and will license your winning Submission and the source code used to generate the Submission under an Open Source Initiative (OSI)-approved license (see https://www.opensource.org) that does not restrict or limit commercial use of such code or of any model containing or depending on such code.

Third-Party Software. For generally commercially available software, libraries, frameworks, or tools that you used to generate your Submission and that are not owned by you, but that can be procured by the Competition Sponsor without undue expense, you are not required to grant the license described in Section 5(a)(1) for such software.

Data and Pretrained Models. In the event that input data or pretrained models subject to incompatible, restrictive, or non-redistributable licenses are used to generate your winning Submission, you are not required to grant an open-source license under Section 5(a)(2) for such data and/or model(s), provided that their use is clearly documented.

b. You may be required by the Competition Sponsor to provide a detailed description of how the winning Submission was generated, in accordance with Section 2.8 (Winner’s Obligations). Such description may include a detailed explanation of the methodology sufficient to reproduce the approach, including, but not limited to, the model architecture, preprocessing steps, loss functions, training procedures, hyperparameters, evaluation methodology, and any other relevant technical details. The description should also include a link to a code repository containing complete and detailed instructions necessary to reproduce the results.
...
After the competition concludes, the hosts will execute the default/pinned version of the notebook linked in the submission description corresponding to each participant’s selected best submission (from the two chosen final submissions).
