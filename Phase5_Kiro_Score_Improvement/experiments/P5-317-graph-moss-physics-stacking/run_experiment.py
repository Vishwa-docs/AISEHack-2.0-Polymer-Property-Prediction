#!/usr/bin/env python3
"""
Experiment P5-317: Wave 9 (PLAN AMENDMENT) — Multi-Branch Hybrid Graph Topology & Physics Inversion Stacking
- Integrates topological graph diffusion embeddings (P5-300) with Moss optical-dielectric physics inversion (P5-305).
- Trains multi-branch GBDTs with SLSQP convex optimization across all targets.
"""
...
def main():
    parser = argparse.ArgumentParser(description="Run P5-317 Graph Topology & Moss Physics Stacking")
    ...
    # Moss optical-dielectric physics coupling
    ...
    print("\n=== Stage 2: Training Multi-Branch Hybrid GBDTs ===", flush=True)
    ...
    print(f"\n==========================================", flush=True)
    print(f"Mean OOF R² (Graph Topology & Moss Physics Stacking): {mean_oof:.5f}", flush=True)
    print(f"==========================================", flush=True)
    ...
    print(f"\n✅ Experiment P5-317 complete! Hash: {pred_hash}", flush=True)
