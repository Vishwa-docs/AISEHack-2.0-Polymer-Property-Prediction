#!/usr/bin/env python3
"""
Experiment P5-321: Wave 10 (PLAN AMENDMENT) — Complete High-Order Graph Diffusion & Self-Consistent Field Ensemble
- Integrates continuous graph diffusion operators with physical self-consistent feedback loops.
- Evaluates SLSQP convex blending across all 7 targets.
"""
...
def main():
    parser = argparse.ArgumentParser(description="Run P5-321 Self-Consistent Graph Field")
    ...
    print("\n=== Stage 2: Training GBDTs with Self-Consistent Graph Field ===", flush=True)
    ...
    print(f"\n==========================================", flush=True)
    print(f"Mean OOF R² (Self-Consistent Graph Field): {mean_oof:.5f}", flush=True)
    print(f"==========================================", flush=True)
    ...
    print(f"\n✅ Experiment P5-321 complete! Hash: {pred_hash}", flush=True)
