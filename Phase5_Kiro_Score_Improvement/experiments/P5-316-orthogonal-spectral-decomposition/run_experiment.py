#!/usr/bin/env python3
"""
Experiment P5-316: Wave 9 (PLAN AMENDMENT) — Orthogonal Residual Spectral Decomposition Blending
- Decomposes prediction arrays into frequency sub-bands via Discrete Cosine Transform (DCT).
- Applies selective regularized gain filtering on high-frequency residuals.
...
def main():
    parser = argparse.ArgumentParser(description="Run P5-316 Orthogonal Residual Spectral Decomposition")
    ...
    print("\n=== Stage 2: Training GBDTs with Spectral Decomposition Blending ===", flush=True)
    ...
    print(f"\n==========================================", flush=True)
    print(f"Mean OOF R² (Spectral Decomposition Blending): {mean_oof:.5f}", flush=True)
    print(f"==========================================", flush=True)
    ...
    print(f"\n✅ Experiment P5-316 complete! Hash: {pred_hash}", flush=True)
