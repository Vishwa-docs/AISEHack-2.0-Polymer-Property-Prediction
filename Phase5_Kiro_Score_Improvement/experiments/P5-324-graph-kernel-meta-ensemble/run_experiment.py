#!/usr/bin/env python3
"""
Experiment P5-324: Wave 10 (PLAN AMENDMENT) — Multi-Scale Hierarchical Graph Kernel Meta-Ensemble
- Integrates multi-scale Weisfeiler-Lehman topological graph kernels with cross-product interaction features.
...
def main():
    parser = argparse.ArgumentParser(description="Run P5-324 Graph Kernel Meta-Ensemble")
    ...
    print("\n=== Stage 2: Training GBDTs with Graph Kernel Meta-Ensemble ===", flush=True)
    ...
    print(f"\n==========================================", flush=True)
    print(f"Mean OOF R² (Graph Kernel Meta-Ensemble): {mean_oof:.5f}", flush=True)
    print(f"==========================================", flush=True)
    ...
    print(f"\n✅ Experiment P5-324 complete! Hash: {pred_hash}", flush=True)
