# P5A-108 — P5A-108-v57-char-alpha-tune

**Focus:** char arm per-target alpha fitted on OOF (replaces fixed 0.20)
**Arms:** char_tune
**Gate:** mean +0.002
...
Run: bash run_final.sh P5A-108   (or all: bash run_final.sh)
