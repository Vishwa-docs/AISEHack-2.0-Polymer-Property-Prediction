#!/usr/bin/env python3
"""P5A-006 - egb via egc covariate overlay (linear map fitted on OOF, alpha up to 0.8). Clean lane: reads ONLY official train.csv / test.csv
...
def main():
    ...
    print("DONE P5A-006 mean_oof_r2=%.4f" % metrics["mean_oof_r2"])
