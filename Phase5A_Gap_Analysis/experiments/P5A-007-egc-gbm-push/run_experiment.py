#!/usr/bin/env python3
"""P5A-007 - egc model zoo: lgb/xgb/extra-trees OOF NNLS blend for egc. Clean lane: reads ONLY official train.csv / test.csv
...
CONFIG = {
    "exp_id": "P5A-007",
    "focus": "egc model zoo: lgb/xgb/extra-trees OOF NNLS blend for egc",
    "egc_zoo": True,
    "n_estimators": 300,
...
def main():
    ...
    print("DONE P5A-007 mean_oof_r2=%.4f" % metrics["mean_oof_r2"])
