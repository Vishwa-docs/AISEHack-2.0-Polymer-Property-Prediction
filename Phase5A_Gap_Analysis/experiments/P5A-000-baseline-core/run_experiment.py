#!/usr/bin/env python3
"""P5A-000 - shared baseline: stage1 per-target ensemble + stage2 cross-property partner features + physics identity overlays. Clean lane: reads ONLY official train.csv / test.csv
...
def main():
    ...
    print("DONE P5A-000 mean_oof_r2=%.4f" % metrics["mean_oof_r2"])
