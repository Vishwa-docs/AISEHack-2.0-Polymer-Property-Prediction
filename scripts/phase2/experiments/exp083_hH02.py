#!/usr/bin/env python3
"""R3-HH02 [hH02] - Phase H: GBM breadth & systematic tuning. Experiment 83/150. Real grouped-CV pipeline; reads ONLY official Dataset/ inputs."""
