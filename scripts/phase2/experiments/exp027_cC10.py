#!/usr/bin/env python3
"""R3-CC10 [cC10] - Phase C: Weak-target physics with ported R2 engines. Experiment 27/150. Real grouped-CV pipeline; reads ONLY official Dataset/ inputs."""
