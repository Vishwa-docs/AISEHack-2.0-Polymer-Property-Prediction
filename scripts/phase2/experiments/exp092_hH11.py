#!/usr/bin/env python3
"""R3-HH11 [hH11] - Phase H: GBM breadth & systematic tuning. Experiment 92/150. Real grouped-CV pipeline; reads ONLY official Dataset/ inputs."""
