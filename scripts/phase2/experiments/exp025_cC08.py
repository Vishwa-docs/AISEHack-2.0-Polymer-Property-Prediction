#!/usr/bin/env python3
"""R3-CC08 [cC08] - Phase C: Weak-target physics with ported R2 engines. Experiment 25/150. Real grouped-CV pipeline; reads ONLY official Dataset/ inputs."""
