#!/usr/bin/env python3
"""R3-BB05 [bB05] - Phase B: Selection repair on the clean arm bank. Experiment 10/150. Real grouped-CV pipeline; reads ONLY official Dataset/ inputs."""
...
def run_experiment(output_dir: Path, smoke: bool = False, data_dir: Path | None = None) -> dict[str, object]:
    ...
    model_fn = lambda X, y: mo.HistGBArm(seed=SEED).fit(X, y)
