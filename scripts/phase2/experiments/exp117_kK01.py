#!/usr/bin/env python3
"""R3-KK01 [kK01] - Phase K: Proper multi-task & cross-property. Experiment 117/150. Real grouped-CV pipeline; reads ONLY official Dataset/ inputs."""
