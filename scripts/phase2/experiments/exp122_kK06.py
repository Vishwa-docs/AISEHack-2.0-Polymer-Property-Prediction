#!/usr/bin/env python3
"""R3-KK06 [kK06] - Phase K: Proper multi-task & cross-property. Experiment 122/150. Real grouped-CV pipeline; reads ONLY official Dataset/ inputs."""
