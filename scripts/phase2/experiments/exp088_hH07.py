#!/usr/bin/env python3
"""R3-HH07 [hH07] - Phase H: GBM breadth & systematic tuning. Experiment 88/150. Real grouped-CV pipeline; reads ONLY official Dataset/ inputs."""
