#!/usr/bin/env python3
"""R3-FF11 [fF11] - Phase F: TTA, invariance, explainability. Experiment 80/150. Real grouped-CV pipeline; reads ONLY official Dataset/ inputs."""
