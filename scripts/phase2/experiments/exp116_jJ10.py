#!/usr/bin/env python3
"""R3-JJ10 [jJ10] - Phase J: Tg deep push part 2. Experiment 116/150. Real grouped-CV pipeline; reads ONLY official Dataset/ inputs."""
...
def run_experiment(output_dir: Path, smoke: bool = False, data_dir: Path | None = None) -> dict[str, object]:
    ...
    print(f"[{EXP_ID}] starting - Tg deep push part 2")
    def model_fn(X, y):
