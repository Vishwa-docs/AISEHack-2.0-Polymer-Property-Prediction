#!/usr/bin/env python3
"""R3-CC02 [cC02] - Phase C: Weak-target physics with ported R2 engines. Experiment 19/150. Real grouped-CV pipeline; reads ONLY official Dataset/ inputs."""
