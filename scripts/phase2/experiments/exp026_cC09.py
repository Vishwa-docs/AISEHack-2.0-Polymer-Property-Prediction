#!/usr/bin/env python3
"""R3-CC09 [cC09] - Phase C: Weak-target physics with ported R2 engines. Experiment 26/150. Real grouped-CV pipeline; reads ONLY official Dataset/ inputs."""
