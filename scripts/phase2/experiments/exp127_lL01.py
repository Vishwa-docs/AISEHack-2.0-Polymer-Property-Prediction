#!/usr/bin/env python3
"""R3-LL01 [lL01] - Phase L: Data curation & validation controls. Experiment 127/150. Real grouped-CV pipeline; reads ONLY official Dataset/ inputs."""
