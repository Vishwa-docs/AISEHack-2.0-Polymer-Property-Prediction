#!/usr/bin/env python3
"""R3-FF08 [fF08] - Phase F: TTA, invariance, explainability. Experiment 77/150. Real grouped-CV pipeline; reads ONLY official Dataset/ inputs."""
