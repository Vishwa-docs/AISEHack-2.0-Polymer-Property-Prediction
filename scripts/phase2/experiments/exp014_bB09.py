#!/usr/bin/env python3
"""R3-BB09 [bB09] - Phase B: Selection repair on the clean arm bank. Experiment 14/150. Real grouped-CV pipeline; reads ONLY official Dataset/ inputs."""
