#!/usr/bin/env python3
"""R3-FF12 [fF12] - Phase F: TTA, invariance, explainability. Experiment 81/150. Real grouped-CV pipeline; reads ONLY official Dataset/ inputs."""
