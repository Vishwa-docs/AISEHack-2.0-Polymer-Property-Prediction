#!/usr/bin/env python3
"""R3-GG03 [gG03] - Phase G: Compound audits & packaging. Experiment 134/150. Real grouped-CV pipeline; reads ONLY official Dataset/ inputs."""
