#!/usr/bin/env python3
"""R3-CC01 [cC01] - Phase C: Weak-target physics with ported R2 engines. Experiment 18/150. Real grouped-CV pipeline; reads ONLY official Dataset/ inputs."""
