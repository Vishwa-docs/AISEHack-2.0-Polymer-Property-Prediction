#!/usr/bin/env python3
"""R3-KK05 [kK05] - Phase K: Proper multi-task & cross-property. Experiment 121/150. Real grouped-CV pipeline; reads ONLY official Dataset/ inputs."""
