#!/usr/bin/env python3
"""R3-CC12 [cC12] - Phase C: Weak-target physics with ported R2 engines. Experiment 29/150. Real grouped-CV pipeline; reads ONLY official Dataset/ inputs."""
