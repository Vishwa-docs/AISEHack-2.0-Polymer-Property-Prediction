#!/usr/bin/env python3
"""R3-HH06 [hH06] - Phase H: GBM breadth & systematic tuning. Experiment 87/150. Real grouped-CV pipeline; reads ONLY official Dataset/ inputs."""
