#!/usr/bin/env python3
"""R3-CC03 [cC03] - Phase C: Weak-target physics with ported R2 engines. Experiment 20/150. Real grouped-CV pipeline; reads ONLY official Dataset/ inputs."""
