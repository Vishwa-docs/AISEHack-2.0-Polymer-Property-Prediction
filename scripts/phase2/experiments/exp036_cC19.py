#!/usr/bin/env python3
"""R3-CC19 [cC19] - Phase C: Weak-target physics with ported R2 engines. Experiment 36/150. Real grouped-CV pipeline; reads ONLY official Dataset/ inputs."""
