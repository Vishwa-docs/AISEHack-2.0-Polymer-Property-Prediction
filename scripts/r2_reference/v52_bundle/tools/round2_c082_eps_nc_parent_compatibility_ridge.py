#!/usr/bin/env python3
"""Official-only EPS exact-v7-parent compatibility residual screen."""
...
def main() -> None:
    ...
    source_names = ("round2_c082_eps_nc_parent_compatibility_ridge.py", "round2_c076_eps_paired_charge_polarizability_residual.py", "round2_c068_eps_physics_informed_residual.py", "round2_c063_egb_endpoint_conjugation_residual.py", "initial_reference_pipeline.py", "round2_eea_cross_target_oof_residual_stack.py")
    report = {
        "schema_version": "ppp.round2.c082.eps-nc-parent-compatibility-ridge.v1",
        "experiment_id": run_dir.name,
        "created_at": datetime.now().astimezone().isoformat(),
        "parent": "R2-C050-20260803-2130-mixed-c001-gap-components-v7; exact v7 parent compatibility bridge",
