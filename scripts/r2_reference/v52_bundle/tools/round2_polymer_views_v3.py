...
def main() -> None:
    ...
    for target in TARGETS:
        ...
        for fold in range(5):
            ...
            candidates[validation_rows, 0] = rich_predict(target_rich_dense, sparse_parts, y_global, indices[train_rows], indices[validation_rows], target, 2026)
            candidates[validation_rows, 1] = rich_sparse_predict(target_rich_dense, sparse_parts, y_global, indices[train_rows], indices[validation_rows], target)
