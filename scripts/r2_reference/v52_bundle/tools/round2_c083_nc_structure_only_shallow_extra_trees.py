#!/usr/bin/env python3
"""Official-only direct-v7 Nc structure-only shallow ExtraTrees residual."""
...
def main() -> None:
    ...
    features = np.hstack([base_features, extra_features, charge])
    feature_names = base_names + extra_names + charge_names
    ...
    source_names = ("round2_c083_nc_structure_only_shallow_extra_trees.py", "round2_c080_eps_nonlinear_multiview_residual.py", "round2_c063_egb_endpoint_conjugation_residual.py", "initial_reference_pipeline.py", "round2_eea_cross_target_oof_residual_stack.py")
    report = {
        "schema_version": "ppp.round2.c083.nc-structure-only-shallow-extra-trees.v1",
        "experiment_id": run_dir.name,
        "created_at": datetime.now().astimezone().isoformat(),
        "parent": "R2-C050-20260803-2130-mixed-c001-gap-components-v7; exact v7 Nc regenerated twice in-process",
