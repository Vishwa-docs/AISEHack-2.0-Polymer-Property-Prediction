...
def main() -> None:
    ...
    source_names = ("round2_c076_eps_paired_charge_polarizability_residual.py", "round2_c068_eps_physics_informed_residual.py", "round2_c063_egb_endpoint_conjugation_residual.py", "initial_reference_pipeline.py", "round2_eea_cross_target_oof_residual_stack.py")
    report = {
        "schema_version": "ppp.round2.c076.eps-paired-charge-polarizability-residual.v1",
