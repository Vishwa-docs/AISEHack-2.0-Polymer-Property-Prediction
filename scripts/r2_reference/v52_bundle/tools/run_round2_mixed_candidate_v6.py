#!/usr/bin/env python3
"""Local clean runner for the v6 candidate library; not embedded in the notebook."""
...
from round2_mixed_candidate_v6 import run_candidate
...
def main() -> None:
    ...
    source_hashes = {
        "candidate_script": sha256_file(tool_root / "round2_mixed_candidate_v6.py"),
