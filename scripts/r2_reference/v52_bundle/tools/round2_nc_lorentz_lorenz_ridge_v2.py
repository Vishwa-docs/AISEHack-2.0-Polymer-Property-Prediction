...
def main() -> None:
    ...
    manifest.extend([f"{source_hashes['script']}  SOURCE tools/round2_nc_lorentz_lorenz_ridge_v2.py", f"{source_hashes['reference_module']}  SOURCE tools/initial_reference_pipeline.py"])
