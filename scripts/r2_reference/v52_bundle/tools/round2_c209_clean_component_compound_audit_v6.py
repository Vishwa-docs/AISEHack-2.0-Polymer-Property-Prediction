#!/usr/bin/env python3
"""C209: deterministic clean component compound audit v6.

This audit-only child runs after C208.  It adds C207 as the first Egc priority
and C208 as the first Tg priority, while preserving the existing banked
Ei/Eea/EPS priorities and strict eligibility checks.
...
actions.  Missing or failed C207/C208 metrics are skipped with explicit reasons.
"""
...
def main() -> None:
    ...
    report = {
        "schema_version": "ppp.round2.c209.clean-component-compound-audit.v6",
