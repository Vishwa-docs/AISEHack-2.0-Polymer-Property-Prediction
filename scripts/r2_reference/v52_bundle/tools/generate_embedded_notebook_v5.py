...
FILES = [
    ...
    ("round2_mixed_candidate_v5", "round2_mixed_candidate_v5.py"),
]
RUNTIME = "experiments/CLEAN_OFFICIAL_ONLY/R2-C050-20260803-2130-mixed-c001-gap-components-notebook-runtime-v6"
...
def main() -> None:
    ...
    code_lines = [
        ...
        "source_hashes = {'candidate_script': source_hashes['round2_mixed_candidate_v5_module'], 'reference_module': source_hashes['initial_reference_pipeline_module'], 'ei_route_module': source_hashes['round2_ei_scaffold_abstaining_gap_identity_v4_portable_module'], 'eea_route_module': source_hashes['round2_eea_scaffold_abstaining_gap_identity_v7_portable_module'], 'metric_plumbing': source_hashes['round2_eea_cross_target_oof_residual_stack_module']}",
        ...
        "    result = sys.modules['round2_mixed_candidate_v5'].run_candidate(DATA_DIR, runtime, output, root_override=ROOT, source_hashes_override=source_hashes)",
        ...
        "cells": [
            {
                ...
                "metadata": {},
                "source": [
                    "# Polymer Round 2 mixed candidate v5\n",
    ...
    output = ROOT / "notebooks" / "R2-C050-mixed-candidate-v5.ipynb"
