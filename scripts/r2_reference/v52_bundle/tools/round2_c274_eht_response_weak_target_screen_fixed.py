"""C274: fixed-length EHT atom-response screen for EPS, Nc, and Ei."""
...
TOOLS = ROOT / "tools"
RUN = ROOT / "experiments/CLEAN_OFFICIAL_ONLY/R2-C274-20260805-eht-response-weak-target-screen-fixed-v1"
