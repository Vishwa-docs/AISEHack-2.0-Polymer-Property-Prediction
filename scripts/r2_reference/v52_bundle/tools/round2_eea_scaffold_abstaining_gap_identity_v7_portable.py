#!/usr/bin/env python3
"""Strictly nested official-only scaffold-abstaining Eea gap-identity diagnostic."""
...
def main() -> None:
    ...
    for target in TARGETS:
        ...
        target_reports[target]["paired_target_gate"] = {
            ...
            "pass": True,
            "basis": "Eea-only component leaves the Ei prediction carrier unchanged; no Ei prediction rows are modified.",
        }
        target_pass = bool(
            delta >= 0.01
    ...
    metrics = {
        "schema_version": "ppp.round2.eea-scaffold-abstaining-gap-identity-run.v1",
    ...
    manifest.extend([
        f"{source_hashes['script']}  SOURCE tools/round2_eea_scaffold_abstaining_gap_identity_v7_portable.py",
