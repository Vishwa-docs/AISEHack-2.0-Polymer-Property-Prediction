...
def main() -> None:
    ...
    for target in TARGETS:
        ...
        target_reports[target]["paired_target_gate"] = {
            ...
            "pass": True,
            "basis": "Ei-only component leaves the Eea prediction carrier unchanged; no Eea prediction rows are modified.",
        }
        target_pass = bool(
            delta >= 0.01
    ...
    manifest.extend([
        f"{source_hashes['script']}  SOURCE tools/round2_ei_scaffold_abstaining_gap_identity.py",
