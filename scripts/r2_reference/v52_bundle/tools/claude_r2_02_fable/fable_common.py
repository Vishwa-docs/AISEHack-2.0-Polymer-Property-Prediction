...
3. No local_eval anywhere. This module never reads any file outside the official
   ppp-round-2 inputs.
...
FORBIDDEN_PATH_TOKENS = ("local_eval", "test_external_labels", "LOCAL_EVAL_ASSISTED")
