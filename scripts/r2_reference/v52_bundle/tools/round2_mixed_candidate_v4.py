...
def run_candidate(
    ...
    report = {
        ...
        "source_hashes": {
            ...
            "ei_route_module": sha256_file(root / "tools" / "round2_ei_scaffold_abstaining_gap_identity_v4_portable.py"),
            "eea_route_module": sha256_file(root / "tools" / "round2_eea_scaffold_abstaining_gap_identity_v7_portable.py"),
    ...
    manifest.extend([
        f"{report['source_hashes']['candidate_script']}  SOURCE tools/round2_mixed_candidate_v4.py",
...
def main() -> None:
    ...
    report = run_candidate(
        ...
        output,
        root_override=root,
        source_hash_override=sha256_file(root / "tools" / "round2_mixed_candidate_v4.py"),
    )
