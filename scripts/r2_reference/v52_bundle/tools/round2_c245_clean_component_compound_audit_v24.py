#!/usr/bin/env python3
"""C245: deterministic compound audit v24 with C244 Tg priority."""
...
import round2_c243_clean_component_compound_audit_v23 as c243


SCHEMA = "ppp.round2.c245.clean-component-compound-audit.v24"
C244_ID = "R2-C244-20260805-0821-tg-median-residual-stack-v1"
CHANGED_FACTOR = (
    "Insert C244 signed-agreement Tg consensus as first Tg priority under the normal component gate while preserving "
    "C243's C232/C228/C208 Tg fallbacks, C242/C240/C236/C234/C226 Nc fallbacks, "
...
def post_patch(run_dir: Path) -> None:
    ...
    metrics["selection_rule"] = (
        "first completed clean-passing target component in frozen priority order; C244 signed-agreement consensus first for Tg, "
        "then C232/C228/C208; no local_eval/public feedback; no same-OOF max search"
    )
    source_hashes = dict(metrics.get("source_hashes", {}))
    source_hashes["c243_wrapper_runner"] = h.sha256_file(Path(c243.__file__).resolve())
...
def main() -> None:
    ...
    base.COMPONENT_PRIORITY["tg"] = [
        C244_ID,
        c243.c241.c239.c237.c235.c233.C232_ID,
        c243.c241.c239.c237.c235.c233.c231.c229.C228_ID,
        "R2-C208-20260805-0352-tg-robust-group-measurement-v1",
    ]
    base.COMPONENT_PRIORITY["egb"] = [
        c243.c241.c239.c237.c235.c233.c231.C230_ID,
        "R2-C201-20260805-0305-safe-egb-cross-property-stage2-v1",
    ]
    base.COMPONENT_PRIORITY["nc"] = [
        c243.C242_ID,
        c243.c241.C240_ID,
        c243.c241.c239.c237.C236_ID,
        c243.c241.c239.c237.c235.C234_ID,
        c243.c241.c239.c237.c235.c233.c231.c229.C226_ID,
        c243.c241.c239.c237.c235.c233.c231.c229.c227.c225.C224_ID,
        c243.c241.c239.c237.c235.c233.c231.c229.c227.c225.C222_ID,
        c243.c241.c239.c237.c235.c233.c231.c229.c227.c225.C218_ID,
    ...
    base.COMPONENT_PRIORITY["eps"] = [
        c243.c241.c239.C238_ID,
        c243.c241.c239.c237.c235.c233.c231.c229.c227.c225.C224_ID,
        c243.c241.c239.c237.c235.c233.c231.c229.c227.c225.C222_ID,
        c243.c241.c239.c237.c235.c233.c231.c229.c227.c225.C216_ID,
    ...
    base.COMPONENT_PRIORITY["ei"] = [
        c243.c241.c239.c237.c235.c233.c231.c229.c227.c225.C224_ID,
        c243.c241.c239.c237.c235.c233.c231.c229.c227.c225.C222_ID,
        c243.c241.c239.c237.c235.c233.c231.c229.c227.c225.C220_ID,
    ...
    base.c203.metric_passes = c243.c241.c239.c237.c235.c233.c231.c229.c227.guarded_metric_passes
    base.main()
