#!/usr/bin/env python3
"""C241: deterministic compound audit v22 with C240 Nc priority."""
...
import round2_c239_clean_component_compound_audit_v21 as c239


SCHEMA = "ppp.round2.c241.clean-component-compound-audit.v22"
C240_ID = "R2-C240-20260805-0733-nc-electro-polar-autocorr-v1"
CHANGED_FACTOR = (
    "Insert C240 as first Nc priority under the normal component gate while preserving "
    "C239's C238 EPS, C236/C234 Nc fallbacks, C232 Tg, C230 Egb, C228 Tg fallback, "
    "C226 Nc fallback, and existing guarded component priorities."
)
...
def helper() -> Any:
    return c239.c237.c235.c233.c231.c229.c227.c225.c223.c221.c219.c217.base.c200


def base_module() -> Any:
    return c239.c237.c235.c233.c231.c229.c227.c225.c223.c221.c219.c217.base
...
def post_patch(run_dir: Path) -> None:
    ...
    metrics["selection_rule"] = (
        "first completed clean-passing target component in frozen priority order; C240 first for Nc, "
        "C238 first for EPS, then prior guarded component priorities under normal component gates; "
        "no local_eval/public feedback; no same-OOF max search"
    )
    source_hashes = dict(metrics.get("source_hashes", {}))
    source_hashes["c239_wrapper_runner"] = h.sha256_file(Path(c239.__file__).resolve())
...
def main() -> None:
    ...
    base.COMPONENT_PRIORITY["tg"] = [
        c239.c237.c235.c233.C232_ID,
        c239.c237.c235.c233.c231.c229.C228_ID,
        "R2-C208-20260805-0352-tg-robust-group-measurement-v1",
    ]
    base.COMPONENT_PRIORITY["egb"] = [
        c239.c237.c235.c233.c231.C230_ID,
        "R2-C201-20260805-0305-safe-egb-cross-property-stage2-v1",
    ]
    base.COMPONENT_PRIORITY["nc"] = [
        C240_ID,
        c239.c237.C236_ID,
        c239.c237.c235.C234_ID,
        c239.c237.c235.c233.c231.c229.C226_ID,
        c239.c237.c235.c233.c231.c229.c227.c225.C224_ID,
        c239.c237.c235.c233.c231.c229.c227.c225.C222_ID,
        c239.c237.c235.c233.c231.c229.c227.c225.C218_ID,
    ...
    base.COMPONENT_PRIORITY["eps"] = [
        ...
        c239.c237.c235.c233.c231.c229.c227.c225.C224_ID,
        c239.c237.c235.c233.c231.c229.c227.c225.C222_ID,
        c239.c237.c235.c233.c231.c229.c227.c225.C216_ID,
    ...
    base.COMPONENT_PRIORITY["ei"] = [
        c239.c237.c235.c233.c231.c229.c227.c225.C224_ID,
        c239.c237.c235.c233.c231.c229.c227.c225.C222_ID,
        c239.c237.c235.c233.c231.c229.c227.c225.C220_ID,
    ...
    base.c203.metric_passes = c239.c237.c235.c233.c231.c229.c227.guarded_metric_passes
    base.main()
