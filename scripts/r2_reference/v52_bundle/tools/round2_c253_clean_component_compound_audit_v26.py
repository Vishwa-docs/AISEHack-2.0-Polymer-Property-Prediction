#!/usr/bin/env python3
"""C253: deterministic compound audit v26 with C252 Nc priority."""
...
import round2_c249_clean_component_compound_audit_v25 as c249


SCHEMA = "ppp.round2.c253.clean-component-compound-audit.v26"
C252_ID = "R2-C252-20260805-0856-nc-eps-ionic-projection-v1"
CHANGED_FACTOR = (
    "Insert C252 Nc selected-EPS ionic projection as first Nc priority under the normal component gate while "
    "preserving C249's C248 Egb priority, C245's C244 Tg priority, older Tg/Egb/Nc fallbacks, "
...
def post_patch(run_dir: Path) -> None:
    ...
    metrics["selection_rule"] = (
        "first completed clean-passing target component in frozen priority order; C252 first for Nc, "
        "C248 first for Egb, C244 first for Tg; no local_eval/public feedback; no same-OOF max search"
    )
    source_hashes = dict(metrics.get("source_hashes", {}))
    source_hashes["c249_wrapper_runner"] = h.sha256_file(Path(c249.__file__).resolve())
...
def main() -> None:
    ...
    base = base_module()
    # Reapply the C249 priority edits, then add C252 ahead of older Nc fallbacks.
    base.COMPONENT_PRIORITY["tg"] = [
        c249.c245.C244_ID,
        c249.c245.c243.c241.c239.c237.c235.c233.C232_ID,
        c249.c245.c243.c241.c239.c237.c235.c233.c231.c229.C228_ID,
        "R2-C208-20260805-0352-tg-robust-group-measurement-v1",
    ]
    base.COMPONENT_PRIORITY["egb"] = [
        c249.C248_ID,
        c249.c245.c243.c241.c239.c237.c235.c233.c231.C230_ID,
        "R2-C201-20260805-0305-safe-egb-cross-property-stage2-v1",
    ]
    base.COMPONENT_PRIORITY["nc"] = [
        C252_ID,
        c249.c245.c243.C242_ID,
        c249.c245.c243.c241.C240_ID,
        c249.c245.c243.c241.c239.c237.C236_ID,
        c249.c245.c243.c241.c239.c237.c235.C234_ID,
        c249.c245.c243.c241.c239.c237.c235.c233.c231.c229.C226_ID,
        c249.c245.c243.c241.c239.c237.c235.c233.c231.c229.c227.c225.C224_ID,
        c249.c245.c243.c241.c239.c237.c235.c233.c231.c229.c227.c225.C222_ID,
        c249.c245.c243.c241.c239.c237.c235.c233.c231.c229.c227.c225.C218_ID,
    ...
    base.COMPONENT_PRIORITY["eps"] = [
        c249.c245.c243.c241.c239.C238_ID,
        c249.c245.c243.c241.c239.c237.c235.c233.c231.c229.c227.c225.C224_ID,
        c249.c245.c243.c241.c239.c237.c235.c233.c231.c229.c227.c225.C222_ID,
        c249.c245.c243.c241.c239.c237.c235.c233.c231.c229.c227.c225.C216_ID,
    ...
    base.COMPONENT_PRIORITY["ei"] = [
        c249.c245.c243.c241.c239.c237.c235.c233.c231.c229.c227.c225.C224_ID,
        c249.c245.c243.c241.c239.c237.c235.c233.c231.c229.c227.c225.C222_ID,
        c249.c245.c243.c241.c239.c237.c235.c233.c231.c229.c227.c225.C220_ID,
    ...
    base.c203.metric_passes = c249.c245.c243.c241.c239.c237.c235.c233.c231.c229.c227.guarded_metric_passes
    base.main()
