...
def nested_split(
    ...
    return {
        ...
        "blend_name": "frozen_c050_ei_v7_weights",
...
def main() -> None:
    ...
    script_path = root / "tools" / "round2_c094_ei_cross_target_oof_residual_v1.py"
    reference_path = root / "tools" / "initial_reference_pipeline.py"
    audit = {
        "schema_version": "ppp.round2.c094.ei-cross-target-oof-residual-run.v1",
        "experiment_id": run_dir.name,
        "created_at": datetime.now().astimezone().isoformat(),
        "parent": "C050-v7 Ei configuration regenerated with fold-masked grouped parent",
    ...
    write_json(run_dir / "config.json", {
        "schema_version": "ppp.round2.c094.ei-cross-target-oof-residual.v1",
        "seed": 2026,
        "target": TARGET,
        "auxiliary_targets": AUXILIARY,
        "outer_folds": 5,
    ...
    manifest.extend([
        f"{audit['source_hashes']['script']}  SOURCE tools/round2_c094_ei_cross_target_oof_residual_v1.py",
