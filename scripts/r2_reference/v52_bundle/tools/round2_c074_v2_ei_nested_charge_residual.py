#!/usr/bin/env python3
"""Official-only C074 accounting-correction reproduction."""
...
def main() -> None:
    ...
    source_names = ("round2_c074_v2_ei_nested_charge_residual.py", "round2_c074_ei_nested_charge_residual.py", "round2_c063_egb_endpoint_conjugation_residual.py", "round2_ei_scaffold_abstaining_gap_identity_v4_portable.py", "initial_reference_pipeline.py", "round2_eea_cross_target_oof_residual_stack.py")
    report = {
        "schema_version": "ppp.round2.c074.ei-nested-charge-residual.v2",
        "experiment_id": run_dir.name,
        "created_at": datetime.now().astimezone().isoformat(),
        "parent": "R2-C074-20260804-1500-ei-nested-charge-residual-v1; accounting-only correction child, same features/model/parent/routes",
